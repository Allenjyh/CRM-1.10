...
function roomPicker(dataSet) {
	...
	var initHtml = (f => {
		...
		level1Arry.forEach(ele => {
			...
			level1Html += `<div class="list_each" id="list_each">  
		...
		level2Arry.forEach(ele => {
			...
			level2Html += `<div class="list_each" >  
							<div class="list_qb_l" style="padding-left: 10px;" >
								<img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
							</div>
							<div class="list_qb_r" style="width: 85.4%;">
		...
		level3Arry.forEach(ele => {
			...
			level3Html +=`<div class="list_each" >  
							<div class="list_qb_l" style="padding-left: 10px;" >
								<img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
							</div>
							<div class="list_qb_r" style="width: 85.4%;">
		...
		level4Arry.forEach(ele => {
			...
			level4Html += `<div class="list_each" >  
								<div class="list_qb_l" style="padding-left: 10px;" >
									<img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
								</div>
								<div class="list_qb_r" style="width: 85.4%;">
		...
		level5Arry.forEach(ele => {
			...
			level5Html +=`<div class="list_each" >  
								<div class="list_qb_l" style="padding-left: 10px;" >
									<img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
								</div>
								<div class="list_qb_r" style="width: 85.4%;">
	...
	class roomPicker {
		...
		constructor(obj, initIndex = 0, callback) {
			...
			this.deg = 0 //初始化偏转的角度
			this.length = 20//this.obj.children.length
		...
		bind(selector) {
			...
			const touchmove = e => {
				...
				e.stopPropagation()
				let iDisY = (e.changedTouches[0].pageY - iStartPageY - getScrollTop())
			...
			const touchend = e => {
				...
				let iDisX = e.changedTouches[0].pageY - getScrollTop() - iStartPageY
...
roomPicker.prototype = {
	...
	controlRoomPicker(id,callback) {
		...
		// 点击选项each
		//this.roomEvent(clickEach, 'click', fn => {
			$(clickEach).find('i').addClass('rep-select').parents('.list_each').siblings().find('i').removeClass('rep-select');
			console.log(clickEach)
