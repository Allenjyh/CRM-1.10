...
function roomPicker(dataSet) {
	...
	var initHtml = (f => {
		...
		level1Arry.forEach(ele => {
			...
			level1Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
		...
		level2Arry.forEach(ele => {
			...
			level2Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
		...
		level3Arry.forEach(ele => {
			...
			level3Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
		...
		level4Arry.forEach(ele => {
			...
			level4Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
		...
		level5Arry.forEach(ele => {
			...
			level5Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
		...
		roomStarAry.forEach(ele => {
			...
			room1Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
		...
		roomEndAry.forEach(ele => {
			...
			room2Html += ` <div class="list_qb_l" style="padding-left: 10px;" >
                             <img style="width: 25px; height: 25px;" src="../../../打卡定位/wechat/images/punch_card/mail_list1.png" alt="">
                         </div>
                         <div class="list_qb_r" style="width: 85.4%;">
                            <p class="fontsize16">${ele.name}</p>
